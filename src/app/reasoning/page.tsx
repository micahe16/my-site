  ...
  return (
    <main className="mx-auto max-w-3xl px-6 py-14">
      ...
      <p className="mt-4 max-w-prose text-muted">
        ...
        Below is the most recent problem solved by my site. There are the 3 types of problems it can answer. 
        All of the numbers in the site come from the same data my API answered with.
      </p>
        ...
        {syllogism ? (
          <div className="mt-3 max-w-prose">
            ...
            <p className="mt-2 max-w-prose text-sm text-muted">
              How the service gets decided: it ignores the details and reads only the shape of
              the argument. The rule says that the if-part brings the then-part, so
              only two observations prove anything: the if-part being true, or the
              then-part being false.
            </p>
          </div>
        ) : (
      ...
      <section className="mt-12">
        ...
        {plausibility ? (
          <div className="mt-3">
            ...
            <p className="mt-2 max-w-prose text-sm text-muted">
              The expected payoff estimates the average result over many repetitions, not the outcome
              of any single trial; it is a guide to value, not a promise of certainty.
            </p>
          </div>
        ) : (
      ...
      <section className="mt-12">
        ...
        {bernoulli ? (
          <div className="mt-3">
            ...
            {"It estimates the expected payoff as the average result over the course of multiple trials, not just a single trial."}
